...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/Hadronizer/Hadronizer_TuneCP5_13TeV_MLM_5f_max4j_qCut19_LHE_pythia8_cff.py nevts:10'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/hadoop/store/user/hnelson2/gridpack_scans/MLsamples/ttHJetgg_ctGTesting01AxisScan_run0_slc7_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'),
