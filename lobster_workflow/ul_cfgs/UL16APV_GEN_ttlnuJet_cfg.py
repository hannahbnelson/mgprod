...
# with command line options: Configuration/GenProduction/python/ttlnuJets_custom_ND-fragment.py --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step GEN --geometry DB:Extended --era Run2_2016_HIPM --fileout file:GEN-00000.root --filein file:LHE-00000.root --python_filename UL16APV_GEN_ttlnuJet_cfg.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ttlnuJets_custom_ND-fragment.py nevts:1'),
