...
# with command line options: Configuration/GenProduction/python/ttHJets_custom_ND-fragment.py --mc --eventcontent LHE --datatier LHE --conditions 106X_upgrade2018_realistic_v4 --step LHE --era Run2_2018 --fileout file:LHE-00000.root --python_filename UL18_LHE_cfg.py --no_exec
